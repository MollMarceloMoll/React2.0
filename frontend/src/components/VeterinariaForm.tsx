...
const VeterinariaForm: React.FC<VeterinariaFormProps> = ({ onSave, onCancel, initialData }) => {
    ...
    <h2 className="text-xl font-bold text-gray-800 border-b pb-2">
      {esEdicion ? "✏️ Actualizando artículo — Veterinaria" : "🐾 Nuevo Artículo — Veterinaria"}
    </h2>
