...
const Granja = () => {
  ...
  // 📌 CAMBIO 2: Filtrar solo mascotas
  const granja = productos.filter((p: any) => p.categoria === "granja");
  ...
  return (
    <div className="p-6 bg-gray-600 rounded-lg shadow border overflow-x-auto">
      <h1 className="text-2xl font-bold mb-4">📦 Lista GRANJA ({granja.length})</h1>
          ...
          {granja.length > 0 ? (
            ...
            <tr>
              <td colSpan={13} className="px-4 py-2 text-center text-white">
                No hay alimentos para animales de granja registrados.
              </td>
            </tr>
          )}
        </tbody>
